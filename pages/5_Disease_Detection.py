...
st.caption("Upload a leaf photo or capture one with your camera. Runs the trained plant disease model.")
...
if model is None:
    ...
    st.warning(f"Couldn't load the model at `model/plant_disease_model.h5`.\n\n**Actual error:** `{real_error}`\n\nThe page still works below for testing the upload/camera flow.", icon="⚠️")
